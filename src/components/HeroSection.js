        ...
        <div className="text-center md:text-left max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <button
              ...
              className="bg-orange-500 hover:bg-orange-600 focus:bg-orange-600 text-white font-bold py-3 px-6 rounded transition-transform duration-300 ease-in-out hover:scale-105 hover:-translate-y-1"
            >
              Get Started
            </button>
            <button
